                ...
                <div className="products" key={item._id}>
                  ...
                  <div className="heart_icon">
                    {wishlist.find((i) => i._id == item._id) ? (
                      <IoHeartSharp onClick={() => addWistlist(item)} />
                    ) : (
                      <IoHeartOutline onClick={() => addWistlist(item)} />
                    )}
                  </div>
                  <div className="basket_icon" onClick={() => addBasket(item)}>
                    <BsBasket3 />
                  </div>
                </div>
              );
        ...
        <div className="best_sellers_section_container">
          ...
          <div className="best_sellers_conatiner">
            <div className="best_sellers_product">
              <img
                src="https://preview.colorlib.com/theme/aroma/img/product/product1.png.webp"
                alt="product"
              />
            ...
            <div className="best_sellers_product">
              <img
                src="https://preview.colorlib.com/theme/aroma/img/product/product2.png.webp"
                alt="product"
              />
            ...
            <div className="best_sellers_product">
              <img
                src="https://preview.colorlib.com/theme/aroma/img/product/product3.png.webp"
                alt="product"
              />
            ...
            <div className="best_sellers_product">
              <img
                src="https://preview.colorlib.com/theme/aroma/img/product/product4.png.webp"
                alt="product"
              />
              <div className="product_category">Decor</div>
              <div className="product_name">Room Flash Light</div>
